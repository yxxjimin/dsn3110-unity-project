#ifndef GPU_UNITY_STANDARD_SHADOW_INCLUDED
#define GPU_UNITY_STANDARD_SHADOW_INCLUDED
	...
	uint vid : SV_VertexID)
{
    ...
    #if defined(UNITY_STANDARD_USE_SHADOW_UVS)
        o.tex = (v.uv * UNITY_ACCESS_INSTANCED_PROP(Props, _MainTex_ST).xy) + UNITY_ACCESS_INSTANCED_PROP(Props, _MainTex_ST).zw;
...
#endif // GPU_UNITY_STANDARD_SHADOW_INCLUDED
